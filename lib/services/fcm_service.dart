...
class FCMService {
  ...
  static Future<void> initialize() async {
    ...
    try {
      ...
      print("❌ FCM Servisi başlatılamadı: $e");
    }
  }
  ...
  static Future<void> _setupLocalNotifications() async {
    ...
    try {
      ...
      print("❌ Local notification'lar ayarlanamadı: $e");
    }
  }
  ...
  static void _setupMessageHandlers() {
    ...
    try {
      ...
      // Uygulama tamamen kapalıyken gelen mesajları kontrol et
      _checkInitialMessage();

      print("✅ Mesaj dinleyicileri ayarlandı");
    } catch (e) {
      print("❌ Mesaj dinleyicileri ayarlanamadı: $e");
    }
  }
  ...
  static Future<void> _checkInitialMessage() async {
    try {
      ...
      if (initialMessage != null) {
        print("🚀 Uygulama kapalıyken gelen mesaj:");
        print("Başlık: ${initialMessage.notification?.title}");
        _handleNotificationTap(initialMessage);
      }
    } catch (e) {
      print("❌ İlk mesaj kontrol edilemedi: $e");
    }
  }
  ...
  static Future<void> _showLocalNotification(RemoteMessage message) async {
    try {
      const AndroidNotificationDetails androidDetails = AndroidNotificationDetails(
        ...
        color: Color(0xFF00AA55),        // Kocaelispor yeşili
      );
      ...
      print("❌ Local notification gösterilemedi: $e");
    }
  }
  ...
  static void _handleNotificationTap(RemoteMessage message) {
    ...
    switch (page) {
      case 'kadro':
        ...
        // Navigator.pushNamed(context, '/kadro');
        break;
      case 'takvim':
        print("📅 Takvim sayfasına yönlendirilecek");
        // Navigator.pushNamed(context, '/takvim');
        break;
      case 'puan':
        print("🏆 Puan durumu sayfasına yönlendirilecek");
        // Navigator.pushNamed(context, '/puan');
        break;
      case 'forum':
        print("💬 Forum sayfasına yönlendirilecek");
  ...
  // Local notification'a tıklandığında çalışacak fonksiyon
  static void _handleLocalNotificationTap(String? payload) {
    print("🔔 Local notification'a tıklandı: $payload");

    if (payload != null) {
      // Payload'dan data'yı çözümle ve sayfa yönlendirmesi yap
      print("Payload verisi: $payload");
    }
  }

  // Token'ı sunucuya gönderme (opsiyonel)
  static Future<void> _sendTokenToServer(String token) async {
    try {
      print("📤 Token sunucuya gönderiliyor: $token");

      // Burada token'ı kendi sunucunuza gönderebilirsiniz
      // Örnek:
      // await http.post(
      //   Uri.parse('https://yourserver.com/api/tokens'),
      //   body: {'token': token, 'user_id': userId},
      // );

    } catch (e) {
      print("❌ Token sunucuya gönderilemedi: $e");
    }
  }
  ...
  static Future<void> sendTestNotification() async {
    ...
    print("Firebase Console > Messaging > Send your first message");
  }

  // Bildirim kanalını oluşturma (Android için)
  static Future<void> createNotificationChannel() async {
    const AndroidNotificationChannel channel = AndroidNotificationChannel(
      'kocaelispor_channel',           // Kanal ID
      'Kocaelispor Bildirimleri',      // Kanal adı
  ...
  static Future<void> clearAllNotifications() async {
    try {
      ...
      print("❌ Bildirimler temizlenemedi: $e");
    }
  }

  // Belirli bir bildirimi temizleme
  static Future<void> clearNotification(int notificationId) async {
    try {
      await _localNotifications.cancel(notificationId);
      print("✅ Bildirim temizlendi: $notificationId");
    } catch (e) {
      print("❌ Bildirim temizlenemedi: $e");
    }
  }
}
...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  // Burada arka plan işlemleri yapabilirsiniz
  // Örnek: Database güncelleme, log kaydetme vs.
}